"""Ingest pipeline for `POST /api/v1/captures` (Ticket 2.2).

Runs entirely inside the caller's transaction. The endpoint owns commit/rollback.
"""
...
async def ingest_capture(
    ...
    # Step 1: RawCapture (warnings may be appended later in this function).
    initial_warnings = (
